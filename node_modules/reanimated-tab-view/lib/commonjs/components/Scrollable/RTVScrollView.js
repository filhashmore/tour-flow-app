...
const RTVScrollView = exports.RTVScrollView = /*#__PURE__*/_react.default.memo( /*#__PURE__*/(0, _react.forwardRef)((props, ref) => {
  ...
  const {
    onBeginDrag,
    onScroll
  } = (0, _useScrollHandlers.useScrollHandlers)(scrollYSV);
  //#endregion
  ...
  (0, _useSyncScrollWithPanTranslation.useSyncScrollWithPanTranslation)(scrollRef, scrollYSV);
  //#endregion
