...
const TabView = exports.TabView = /*#__PURE__*/_react.default.memo( /*#__PURE__*/_react.default.forwardRef((props, ref) => {
  ...
  }, [navigationState, renderMode, tabBarType, tabBarPosition, tabBarScrollEnabled, tabBarDynamicWidthEnabled, scrollableTabWidth, tabBarStyle, tabBarIndicatorStyle, tabStyle, tabLabelStyle, swipeEnabled, jumpMode, sceneContainerGap, sceneContainerStyle, keyboardDismissMode, providedAnimatedRouteIndexSV, renderTabBar, renderScene, renderHeader, onIndexChange, onSwipeEnd, onSwipeStart]);
  ...
  }, /*#__PURE__*/_react.default.createElement(_TabLayout.TabLayoutContextProvider, null, /*#__PURE__*/_react.default.createElement(_Scrollable.ScrollableContextProvider, null, /*#__PURE__*/_react.default.createElement(TabViewWithoutProviders, null)))));
}));
