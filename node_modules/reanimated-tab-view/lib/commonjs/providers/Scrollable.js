...
exports.useScrollableContext = exports.ScrollableContextProvider = void 0;
...
const ScrollableContext = /*#__PURE__*/(0, _react.createContext)({
...
const ScrollableContextProvider = exports.ScrollableContextProvider = /*#__PURE__*/_react.default.memo(function ScrollableContextProvider({
  children
}) {
  ...
  return /*#__PURE__*/_react.default.createElement(ScrollableContext.Provider, {
    value: value
  }, children);
});
const useScrollableContext = () => (0, _react.useContext)(ScrollableContext);
exports.useScrollableContext = useScrollableContext;
