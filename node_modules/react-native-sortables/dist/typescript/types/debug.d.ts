...
]> & Pick<ViewStyle, 'backgroundColor' | 'borderColor' | 'borderStyle' | 'borderWidth'> & {
    isAbsolute?: boolean;
...
type CreateDebugComponentUpdater<T extends DebugComponentType, P extends {
    isAbsolute?: boolean;
}> = {
    props: SharedValue<P>;
    hide: () => void;
...
export type DebugComponentUpdater<T extends DebugComponentType> = T extends DebugComponentType.LINE ? CreateDebugComponentUpdater<T, DebugLineProps> : T extends DebugComponentType.RECT ? CreateDebugComponentUpdater<T, DebugRectProps> : T extends DebugComponentType.CROSS ? CreateDebugComponentUpdater<T, DebugCrossProps> : never;
...
export type DebugViews = Record<number, DebugComponentUpdater<DebugComponentType>>;
export {};
