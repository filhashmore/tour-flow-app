...
const loadNative = isTurboModuleEnabled => {
  const hapticFeedback = isTurboModuleEnabled ? TurboModuleRegistry.get('RNHapticFeedback') : NativeModules.RNHapticFeedback;
...
const load = () => {
  try {
    ...
    const trigger = (type = HapticFeedbackTypes.selection, options = {}) => {
      'worklet';
...
//# sourceMappingURL=react-native-haptic-feedback.js.map